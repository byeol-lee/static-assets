const activities = [
    {
        ...
        <br />
        The One-Day Lesson takes place step-by-step under systematic guidance from professional instructors, covering safety education, equipment usage, kite manipulation, and ocean practice, allowing beginners to learn the basics of kitesurfing comfortably.<br />
        <br />
        ...
        <ul class="dot-bu-list">
            ...
            <div class="common-txt">
                ...
                <ul class="dot-bu-list">
                    <li>Cancellation 1 day before the date of use: A 50% cancellation fee of the total payment will apply.</li>
                    <li>Cancellation on the day of use: A 100% cancellation fee of the total payment will apply.</li>
    ...
    },
    {
        ...
        <br />
        Onboard, cup fruit, draft beer, beverages, and light snacks are provided. On lucky days, a special moment awaits where you might spot dolphins freely swimming in the Jeju ocean.<br />
        <br />
        ...
        <p class="ref-bu-list">※ In case of severe weather on the day(rain, high waves, etc.) making operation difficult, cancellations will be processed.</p>
        <p class="ref-bu-list">※ Same-day time changes are allowed up to 2 hours prior to departure.</p>
        <p class="ref-bu-list">※ Pets are allowed only for small dogs under 10kg. They must be kept in a cage or pet carrier during boarding.<br />
        ...
        <ul class="dot-bu-list">
            ...
            <div class="common-txt">
                <p class="strong">[Cancellation/Refund Policy]</p>
                <ul class="dot-bu-list">
                    <li>Same-day time changes are permitted up to 2 hours before departure.</li>
                    <li>Cancellation 1 day before the date of use: A 20% cancellation fee of the total payment will apply.</li>
                    <li>Cancellation on the day of use: A 50% cancellation fee of the total payment will apply.</li>
                    <li>Cancellations due to severe weather or vendor circumstances: 100% full refund.</li>
                </ul>
            </div>
        </ul>
    ...
    },
    {
        ...
        <ul class="dot-bu-list">
            ...
            <li>Hosts may cancel participation if a participant is in an unfit condition(intoxication, excitement, hostile behavior, etc.).</li>
            <li>Bookings made between 21:00 the previous day and 08:00 on the day of use, or same-day bookings, may be changed or canceled based on reservation status and weather conditions.</li>
            <li>Programs may be canceled on the day depending on weather conditions; individual notifications will be sent 2 hours before departure with a 100% refund.</li> <br />
            <div class="common-txt">
                <p class="strong">[Cancellation/Refund Policy]</p>
                <ul class="dot-bu-list">
                    <li>Up to 4 days prior to use: No cancellation fee</li>
                    <li>3 days prior to use: A 10% cancellation fee applies</li>
                    <li>2 days prior to use: A 30% cancellation fee applies</li>
                    <li>1 day prior to use: A 50% cancellation fee applies</li>
                    <li>Day-of No-Show: A 100% cancellation fee applies</li>
                </ul>
            </div>
        </ul>
        `,
    ...
    },
    {
        ...
        <div class="common-txt">
            <p class="strong">[Cancellation/Refund Policy]</p>
            <ul class="dot-bu-list">
                <li>Reservation time changes are only allowed up to 1 day before class.</li>
    ...
    },
    {
        ...
        <p class="ref-bu-list">※ Duration is approx. 1 hour to 1 hour 30 minutes.</p>
    ...
    },
    {
        ...
        <div class="common-txt">
            <p class="strong">[Cancellation/Refund Policy]</p>
            <ul class="dot-bu-list">
                <li>Please complete entry at least 10 minutes prior to program start.</li>
                <li>Entry after scheduled time is not permitted, and refunds due to missed entry are unavailable.</li>
                <li>Up to 1 hour before program start: Cancellation and 100% refund available</li>
                <li>Cancellation within 1 hour of program start: Non-refundable</li>
                <li>Day-of No-Show: A 100% cancellation fee applies</li>
            </ul>
        </div>
        `,
    ...
    },
    {
		...
		subtitle: 'Experience pottery shaping crafted by delicate fingertips at Seongji Pottery',
		description: `
        An experience where you make traditional pottery using a potter's wheel.<br />
        Select your desired items like 2 teacups, plates, or mugs to create. Completed works will be delivered via courier after two months!<br />
        (Shipping fees are included in the Play participation fee.)<br />
        If you wish to create larger pieces or add intricate inlaid patterns, extra payment can be made on-site.<br />
        <br />
        [About Seongji Pottery]<br />
        Seongji Pottery has been sharing pleasant encounters through traditional pottery experiences in Jeju for 25 years.<br />
        It is registered as a career experience certification institution designated by the Ministry of Education and designated as a traditional cultural personality education center.<br />
        A healing space for everyone—couples, families, groups, or individuals of all ages and genders.
        `,
        ...
        `,
		notice: `
        <li>Same-day reservation unavailable.(Phone inquiry for same-day booking: +82-64-766-3083)</li>
        <li>Reservations close at 17:00 on the day prior to use.</li>
        <li>Phone & Naver TalkTalk consultations: Weekdays(Mon ~ Fri) 09:00 ~ 18:00.</li>
        <li>Detailed information can be checked via Naver Booking - Details.</li>
        <li>On-site booking is accepted for remaining slots, but if advance booking closes, on-site booking is unavailable.</li>
        <li>This program is conducted in Korean only.</li>
        <li>Hotel guest discount does not apply to this program.</li>
        <li>Nighttime bookings(between 17:00 previous day and 09:00 same day) or same-day bookings may be subject to change or cancellation depending on availability and weather conditions.</li>
        <li>No-Shows will be declared if absent without prior notice or arriving more than 10 minutes after scheduled time.</li><br />
        <li>Activity programs operate on a advance reservation basis.</li>
        <li>This program is subject to change based on organizer and host circumstances.</li>
        <li>Hosts may cancel participation if a participant is in an unfit condition(intoxication, excitement, hostile behavior, etc.).</li><br />
        <div class="common-txt">
            <p class="strong">[Cancellation/Refund Policy]</p>
            <ul class="dot-bu-list">
                <li>Up to 4 days prior to use: No cancellation fee</li>
    ...
    },
    {
        ...
        <p class="ref-bu-list">※ This class proceeds when 2 or more participants sign up.</p>
        <p class="ref-bu-list">※ Operating days are subject to change depending on instructor schedules.</p>
        <p class="ref-bu-list">※ Specific details are subject to change.</p>
        <!-- <ul class="dot-bu-list">
            <li>09:50 - Gathering at Playce Camp Activity Lounge</li>
            <li>10:00 - Class Introduction</li>
            <li>10:50 - Stretching & Class Session</li>
