const activities = [
    ...
    },
    {
		...
		notice: `
        <ul class="dot-bu-list">
            <li>별도의 사전 예약 없이 이용 가능하며, 플레이스 캠프 투숙 내역을 증빙하여 방문 시 전용 혜택을 받으실 수 있습니다.</li>
            <li>주차 무료</li>
        </ul>
        `,
		reservation: false,
    ...
    },
    {
		...
		description: `
        물레를 이용해 전통 방식으로 나만의 도자기를 만들어보는 체험입니다.<br />
        커피잔, 머그컵, 그릇, 앞접시, 술잔(2개) 체험 품목 중 원하는 작품을 선택해 직접 제작할 수 있습니다.<br />
        <br />
        기본 체험에 상감 기법을 활용한 무늬 표현까지 포함되어 있어, 원하는 문양을 새겨 나만의 개성이 담긴 도자기를 완성할 수 있습니다.<br />
        <br />
        완성된 작품은 건조와 소성 과정을 거쳐 완성되며, 완성품 택배 발송 비용까지 체험비에 포함되어 있어 별도의 배송비 부담 없이 받아보실 수 있습니다.<br />
        <br />
        <p class="ref-bu-list">※ 작품의 크기나 추가 제작 내용에 따라 별도 비용이 발생할 수 있습니다.</p>
        `,
        ...
        <li>사전 연락 없이 불참하거나 프로그램 시작 후 10분 이내에 도착하지 않을 경우 No-Show로 간주되어 참여가 제한될 수 있습니다.</li>
        <li>프로그램은 주최 측 및 호스트의 운영 상황에 따라 일정이나 내용이 변경될 수 있습니다.</li><br />
        <div class="common-txt">
            <p class="strong">[취소/환불 규정]</p>
            <ul class="dot-bu-list">
                <li>이용 4일 전까지: 결제 금액에 대한 취소 수수료 없음</li>
